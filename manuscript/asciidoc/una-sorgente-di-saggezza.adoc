...
questo termine può avere molti significati (si veda il _Glossario_, p.
FIXME:pageref); in questo discorso il venerabile Ajahn Chah fa
...
Risveglio, si veda il _Glossario_, p. FIXME:pageref, alla voce
_bojjhaṅga_.] Se c’è _sati_, rammemorazione, l’effetto sarà il
