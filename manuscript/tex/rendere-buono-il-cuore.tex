...
meriti.\footnote{``Cercare meriti'' è una frase comunemente utilizzata
  ...
  monasteri (``wát'', tempio: วัด) per porgere omaggio a venerati
...
pallottole,\footnote{È un gioco di parole tra \emph{luuk} (ลูก), che
  significa figli, e \emph{luuk puen} (ลูกปืน), che letteralmente
