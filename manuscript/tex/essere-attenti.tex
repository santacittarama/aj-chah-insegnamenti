...
Dopo aver meditato sulle ``trentadue parti del corpo''\footnote{``trentadue
  ...
  attraenti (\emph{asubha}) e insoddisfacenti (\emph{dukkha}).} e averle
riconosciute come un qualcosa di non stabile o permanente, non abbiamo
...
mia. È un peccato.\footnote{บาป (\emph{bààp}), in thailandese.}~» Ehi!
...
sbagliato, e così vi astenete da quest'azione. È cattivo \emph{kamma}?
Non è che ogni volta che avete un impulso accumulate istantaneamente un
\emph{kamma} negativo. Come potrebbe esserci altrimenti una via per la
...
allora state creando qualcosa. \emph{Avijjā~}\footnote{\emph{avijjā}.
  Non conoscenza, ignoranza; consapevolezza offuscata.} ha assunto il
...
al suo posto vi è \emph{vijjā}.\footnote{\emph{vijjā}. Conoscenza
  genuina, più specificamente facoltà cognitiva sviluppata tramite la
  pratica di meditazione e il discernimento.} L'impulso mentale non è
attuato.
...
Avere solo dei pensieri non è cattivo \emph{kamma}. Se non abbiamo alcun
...
\emph{jhāna~}\footnote{\emph{jhāna}. Assorbimento mentale; uno stato di
  ...
  conduce a un \emph{arūpajhāna}).} e \emph{samāpatti}.\footnote{\emph{samāpatti}.
  ``Ottenimento''. Termine che indica i quattro assorbimenti
  immateriali, o i Frutti del Sentiero nei vari stadi
  dell'Illuminazione.} Egli considerava il \emph{samādhi} come uno dei
...
quel momento i \emph{devadūta},\footnote{\begin{quote}
  \emph{devadūta}. ``Messaggero divino''; nome simbolico per la
  vecchiaia, la malattia e la morte e per il \emph{samaṇa} (asceta
  mendicante).
  \end{quote}} che insegnano tutti i giorni agli anziani, stanno
...
creare ogni genere di \emph{kamma} e di demeriti. Ci può condurre in
...
schiavi del desiderio e creiamo ogni tipo di \emph{kamma} e di cattive
...
producendo un cattivo \emph{kamma}.

Non riuscite a comprenderlo del tutto. Chi dona per ottenere merito
accumula istantaneamente un cattivo \emph{kamma}. Donare per lasciar
andare e per rendere la mente libera, questo porta merito. Se lo fate
per ottenere qualcosa, è cattivo \emph{kamma}. È difficile ascoltare gli
...
Il grande Maestro insegnò il Dhamma e il Vinaya.\footnote{Vinaya. Il
  codice della disciplina monastica buddhista.} Sono perfetti e
...
chiarezza. \emph{Samudaya},\footnote{\emph{samudaya}. Origine,
  originazione, il sorgere; causa.} la causa della sofferenza, non viene
...
qualche altra parte, non ci fanno creare \emph{kamma} e non ci arrecano
...
grazie al nostro buon \emph{kamma} appartiene pur sempre al mondo ed è
...
Le persone con un buon \emph{kamma} mondano hanno un'intelligenza che
