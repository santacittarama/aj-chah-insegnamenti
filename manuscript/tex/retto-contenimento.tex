...
riusciti ad arrivarci, pensano di avere un \emph{kamma} davvero buono.
...
pensiamo di essere delle persone che hanno proprio un buon \emph{kamma}.
I monaci stranieri è lì che sono nati: questo significa forse che hanno
un \emph{kamma} migliore del nostro? Questo genere di idee della gente
...
\emph{Nak Tham Ehk}\footnote{\emph{Nak Tham Ehk} (นักธรรมเอก). In
