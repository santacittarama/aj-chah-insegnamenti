...
\emph{kuṭī}\textsuperscript{~}\footnote{\emph{kuṭī}. La piccola dimora
...
lasciato il mondo?\footnote{\begin{quote}
  ...
  o \emph{samanera}.
  \end{quote}} Perché stiamo praticando? Abbiamo lasciato il mondo per
