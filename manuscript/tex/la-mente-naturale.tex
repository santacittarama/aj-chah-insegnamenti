...
\textbf{La saggezza dell'esperienza quotidiana}
...
\textbf{Conoscere se stessi, conoscere gli altri}
...
Per il nostro Vinaya\footnote{Vinaya. Il codice della disciplina
...
\textbf{La meditazione di visione profonda (\emph{vipassanā})}\footnote{\emph{vipassanā}.
  Visione profonda di natura intuitiva dei fenomeni fisici e mentali, e
  del loro sorgere e scomparire.}
...
\textbf{La meditazione di tranquillità (\emph{samatha})}

Questa è ad esempio la nostra pratica di
\emph{samatha}.\textsuperscript{~}\footnote{\emph{samatha}. Calma
