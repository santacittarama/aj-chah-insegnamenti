...
\item[ajahn] (thai: \thai{อาจารย์}) Il
...
\item[anāgāmin, anāgāmī] (pāli) ``Chi è senza ritorno'', ossia chi ha
...
\item[añjali] (pāli) È un gesto di rispetto consistente nel congiungere le
...
\item[anusaya] (pāli) Predisposizione; tendenza latente. Ci sono sette
...
\item[ariya-sacca, ariya-saccāni] (pāli) Nobile Verità. Le Quattro
...
\item[asaṅkhata-dhamma] (pāli) Si veda il suo opposto →
...
\item[bhava] (pāli) Esistenza; divenire; una ``vita''. Stati dell'esistenza
...
\item[bhikkhunī] (pāli) Una monaca buddhista; una donna che ha rinunciato al
...
\item[bodhi-pakkhiya-dhamma] (pāli) Le parti del Risveglio, ossia i
...
\item[bojjhaṅga] (pāli) I sette fattori del Risveglio: consapevolezza (→
...
\item[brāhmaṇa] (pāli) (1) Brahmano, membro della casta dei brahmani,
...
\item[Buddha-sāsana] (pāli) La dottrina del Buddha; si riferisce in primo
...
\item[cetasika] (pāli) Fattore mentale che accompagna il → \emph{citta} o
...
\item[Dhamma] (pāli) È un termine difficilmente traducibile e con un
...
\item[Dhamma-Vinaya] (pāli) ``Dottrina e Disciplina'', il nome attribuito dal Buddha
a ciò che insegnava.

\item[dhana] (pāli) Tesoro. I \emph{dhana} sono le sette qualità della fiducia
...
\item[dhutaṅga] (pāli) Pratica ascetica volontaria che i praticanti possono
...
\item[diṭṭhi] (pāli) Visione, opinione, convinzione, concezione. In generale
...
\item[dukkha] (pāli) ``Dis-agio'', ``difficile da sopportare'',
...
\item[ekaggatā] (pāli) Unificazione mentale; il quinto fattore
...
\item[Entrata nella Corrente] (pāli: \emph{sotāpatti}) Evento tramite il quale si
...
\item[glot] (thai: \thai{กลค}) Ombrello con una zanzariera
...
\item[gotrabhū-ñāṇa] (pāli) ``Conoscenza del cambio di lignaggio'':
...
\item[hiri-ottappa] (pāli) Coscienza morale e timore di compiere cattive
...
\item[iddhipāda, iddhipādā] (pāli) Base del potere psichico; sentiero
...
\item[Illuminazione] (pāli: \emph{bodhi}) L'Illuminazione o Risveglio si realizza
...
\item[kalyāṇamitta] (pāli) Amico spirituale, maestro che consiglia o insegna
il Dhamma.
...
\item[kamma] (pāli) Atto intenzionale compiuto per mezzo del corpo, della
...
\item[kasiṇa] (pāli) Oggetto esterno di meditazione utilizzato per sviluppare
...
\item[khandha, khandhā] (pāli) Aggregato, insieme di elementi col
...
\item[kilesa, kilesā] (pāli) Contaminazione; inquinante mentale;
...
\item[kusala] (pāli) Salutare, abile, buono, meritorio. Un'azione
...
\item[Luang Por] (thai: \thai{หลวงพ่อ}) ``Venerabile padre''; è
...
\item[mahat, mahā-] (pāli) ``Grande, importante, superiore''. Nella
...
\item[majjhimā-paṭipadā] (pāli) Via di Mezzo; → Nobile Ottuplice
Sentiero.
...
\item[moha] (pāli) Confusione; ignoranza (→ \emph{avijjā}). Una delle tre
...
\item[nāma-dhamma, nāma-dhammā] (pāli) Fenomeno mentale; →
\emph{nāma}.

\item[ñāṇadassana] (pāli) Conoscenza e visione, anche all'interno delle
Quattro Nobili Verità (→ \emph{ariya-sacca}).

\item[ñāyapaṭipanna, ñāyapaṭipanno] (pāli) Coloro la cui pratica è
...
\item[nimitta, nimittaṃ] (pāli) Segno mentale, immagine o visione che
...
\item[opanayika, opanayiko] (pāli) ``Che conduce all'interno'', degno
...
\item[pāramī] (pāli) ``Perfezione''. Un gruppo di dieci qualità sviluppate
...
\item[Pāṭimokkha] (pāli) Il codice fondamentale della disciplina monastica,
...
\item[paṭipadā] (pāli) Strada, via, sentiero; i mezzi per raggiungere lo scopo
...
\item[rūpa] (pāli) Fenomeno fisico; dato sensoriale. Il significato basilare
...
\item[sabhāva] (pāli) Letteralmente, ``natura propria''. Principio o
condizione della natura, qualcosa che è come veramente è; →
\emph{sabhāva-dhamma}.

\item[sabhāva-dhamma] (pāli) Fenomeno condizionato della natura;
...
\item[sakadāgāmin, sakadāgāmī] (pāli) Il secondo stadio
...
\item[sakkāya-diṭṭhi] (pāli) Convinzione che induce l'identificazione con il
...
\item[samaṇa] (pāli) Un contemplativo. Letteralmente, chi abbandona gli
...
\item[sāmañña-lakkhaṇa] (pāli) Indica che tutto è identico nei termini delle
...
\item[sāmīcipaṭipanna, sāmīcipaṭipanno] (pāli) Colui la cui pratica è
...
\item[saṃsāra] (pāli) Flusso del Divenire o dell'Esistenza; un vagare
...
\item[saṃyojana] (pāli) Catena che lega la mente alla ruota della rinascita (→
...
\item[saṅkhāra] (pāli) Formazione; fenomeno condizionato. Il termine può
...
\item[satipaṭṭhāna] (pāli) Fondamento della consapevolezza. I quattro
...
\item[sekha] (pāli) Chi si sottopone all'addestramento spirituale; il termine
...
\item[sīla] (pāli) Virtù, moralità; precetto. Purezza morale la quale evita
...
\item[sīla-dhamma] (pāli) Un altro modo per indicare gli insegnamenti morali
del buddhismo. A livello personale, ``virtù (e conoscenza) della
verità''.

\item[sotāpanna] (pāli) ``Chi è entrato nella Corrente'' e ha così conseguito
...
\item[sutta] (pāli) Letteralmente, ``filo''. Un discorso o sermone del Buddha
...
\item[taṇhā] (pāli) Letteralmente, ``sete''. Bramosia per gli oggetti dei
...
\item[tilakkhaṇa] (pāli) Letteralmente, ``Tre Caratteristiche''. Le qualità di
...
\item[tiratana] (pāli) La ``Triplice Gemma'', composta dal Buddha, dal Dhamma
...
\item[upasampadā] (pāli) Accettazione; ordinazione piena di un →
...
\item[vedanā] (pāli) Sensazione. Può essere dolorosa
...
\item[vimutti] (pāli) Liberazione, libertà dalle formazioni e dalle
...
\item[Vinaya] (pāli) Il codice della disciplina monastica buddhista; letteralmente,
...
\item[vipassanā] (pāli) Visione profonda di natura intuitiva dei fenomeni
