...
% TODO: footnote index 4 on 'R. Gnoli, Milano 2007', but footnote text not found.
...
\item[Dhamma] (pāli) È un termine difficilmente traducibile e con un notevole
...
\item[iddhipāda, iddhipādā] (pāli) Base del potere psichico; sentiero del
...
\item[veste monastica] La veste monastica dei monaci \emph{theravādin} che copre
  ...
  \emph{āntara-vāsaka}; in thailandese \emph{sabong}, \thai{สบง}). Oltre alla
  veste superiore e a quella inferiore vi è una veste esterna a doppio strato
  (in pāli \emph{saṅghāti}; in thailandese \emph{sanghati}, \thai{สังฆาฏิ}) che in
