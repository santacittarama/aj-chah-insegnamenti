...
\textsc{Introduzione di Ajahn Jayasāro.} Questo discorso,
...
ajahn}\footnote{\emph{kruba ajahn} (thailandese: ครูบาอาจารย์). Si
...
Per l'annuale \emph{Phra Vessandara Ngan}\footnote{Come si dice nel
  testo, il \emph{Phra Vessandara Ngan} (in thailandese พระเวสสันดร) è
...
Phra}\footnote{\emph{Wan Phra} (in thailandese วันพระ). Il giorno di
...
fanno. Portate la veste per la balneazione\footnote{In thailandese
  \emph{pahapnamfon} (ผ้าอาบน้ำฝน). Si tratta di un pezzo di stoffa
...
\emph{sabong}.\footnote{La veste monastica dei monaci \emph{theravādin}
  ...
  (in pāli: \emph{uttarā-saṅgha}; in thailandese \emph{jeewon}, จีวร)
  ...
  \emph{sanghati}: สังฆาฏ) che in genere viene portata ripiegata lungo
...
\emph{jongrom}\footnote{\emph{jongrom}. Parola thailandese (จงกรม,
  เดินจงกรม) per il termine pāli \emph{cankama}; indica la meditazione
