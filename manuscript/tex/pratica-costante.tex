...
un disastro. La pratica è una cosa, un disastro è un'altra.\footnote{Sia
  ...
  parole thailandesi \emph{patibat} (pratica: ปฏิบัติธร) e \emph{wibut}
  (disastro: วิบัติ).} La maggior parte della gente fa disastri. Quando
...
\emph{Buddho}, \emph{Buddho}, \emph{Buddho} ... questo è conoscere.
...
\emph{pah-kao}.\footnote{\emph{pah-kao}. Termine thailandese (ผ้าขาว;
  ปะขาว) per \emph{anāgārika}; letteralmente, ``non cittadino'', ossia
