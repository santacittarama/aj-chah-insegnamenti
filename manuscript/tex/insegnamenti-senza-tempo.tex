...
Precetti\footnote{Cinque Precetti. Le linee guida morali per le azioni e
  i pensieri salutari; per un elenco si veda il \emph{Glossario}, alla
  voce Precetti.} basilari per far notare che \emph{sīla}\footnote{\emph{sīla}.
  Virtù, moralità; precetto.} è il genitore più importante di tutte le
...
di \emph{samādhi}.\footnote{\emph{samādhi}. Concentrazione, unificazione
  della mente, stabilità mentale.}
