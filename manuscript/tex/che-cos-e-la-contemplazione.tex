...
corpo''?\textsuperscript{~}\footnote{``trentadue parti del corpo''. Un
...
\emph{vipassanā}?\textsuperscript{~}\footnote{~\emph{vipassanā}. Visione
...
(\emph{samādhi})\textsuperscript{~}\footnote{\emph{samādhi}.
