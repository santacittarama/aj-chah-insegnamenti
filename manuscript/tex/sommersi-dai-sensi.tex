...
divenire. ``Divenire'' (\emph{bhava})\footnote{La parola thailandese per
  \emph{bhava} (\emph{pop}: ภพ; ภพชาติ), era famigliare per chi
...
\emph{Vaṭṭa},\footnote{\begin{quote}
  \emph{vaṭṭa}. ``Ciò che gira'', quel che va avanti, o è consueto,
  ossia dovere, servizio, consuetudine.
  \end{quote}} la ruota dell'esistenza dei fenomeni condizionati,
