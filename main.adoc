...
include::{includes}/part-1-pratica-quotidiana.adoc[]
...
include::{includes}/part-2-pratica-formale.adoc[]
...
include::{includes}/part-3-pratica-della-rinuncia.adoc[]
